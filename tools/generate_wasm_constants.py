...
wasmInstructions = parseIndex(instructionsIndex, lambda r: r[0])
...
if __name__ == '__main__':
    ...
    f = open(fpath)
    f.write("# This file is automatically generated using tools/generate_wasm_constants.py\n")
    ...
    writeKeyVal = lambda item: f.write(f'{item[0]} = {hex(item[1])}\n')
