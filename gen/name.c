...
Slc instrName(U1 instr) {
  switch(instr) {
    ...
    case SLIT + 0x0: return Slc_ntLit("0x0");
    case SLIT + 0x1: return Slc_ntLit("0x1");
    case SLIT + 0x2: return Slc_ntLit("0x2");
    case SLIT + 0x3: return Slc_ntLit("0x3");
    case SLIT + 0x4: return Slc_ntLit("0x4");
    case SLIT + 0x5: return Slc_ntLit("0x5");
    case SLIT + 0x6: return Slc_ntLit("0x6");
    case SLIT + 0x7: return Slc_ntLit("0x7");
    case SLIT + 0x8: return Slc_ntLit("0x8");
    case SLIT + 0x9: return Slc_ntLit("0x9");
    case SLIT + 0xA: return Slc_ntLit("0xA");
    case SLIT + 0xB: return Slc_ntLit("0xB");
    case SLIT + 0xC: return Slc_ntLit("0xC");
    case SLIT + 0xD: return Slc_ntLit("0xD");
    case SLIT + 0xE: return Slc_ntLit("0xE");
    case SLIT + 0xF: return Slc_ntLit("0xF");
